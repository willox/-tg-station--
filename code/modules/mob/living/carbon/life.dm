...
/mob/living/carbon/proc/check_breath(datum/gas_mixture/breath)
	...
	//NITROUS OXIDE
	if(breath.has_gas(/datum/gas/nitrous_oxide))
	...
	if(breath.has_gas(/datum/gas/bz))
	...
	//MIASMA
	if(breath.has_gas(/datum/gas/miasma))
